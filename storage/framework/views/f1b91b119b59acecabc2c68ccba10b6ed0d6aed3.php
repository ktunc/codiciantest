                ...
                <table class="table table-hover table-bordered">
                    ...
                    <?php $__currentLoopData = $persons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($person->company_id); ?></td>
                            ...
                            <td class="text-center"><button type="button" class="btn btn-sm btn-warning" onclick="FuncPersonInfo(<?php echo e($company->id); ?>, <?php echo e($person->id); ?>)">Update</button></td>
                            <td class="text-center"><button type="button" class="btn btn-sm btn-danger" onclick="FuncPersonDelete(<?php echo e($company->id); ?>, <?php echo e($person->id); ?>)">Delete</button></td>
                        </tr>
                ...
                buttons:{
                    ...
                    delete:{
                        ...
                        action: function () {
                            $.ajax({
                                type:'POST',
                                url:"<?php echo e(url('/persondelete')); ?>",
                                data:{'cid':cid, 'pid':pid},
                                dataType:'json',
                            }).done(function (data) {
                                if(data){
