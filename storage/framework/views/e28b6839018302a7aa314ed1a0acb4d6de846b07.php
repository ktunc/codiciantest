            ...
            <table class="table table-hover table-bordered">
                ...
                <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($company->internet_address); ?></td>
                        <td class="text-center"><img src="<?php echo e(asset('/storage/company/'.$company->id.'.jpg')); ?>" class="rounded img-thumbnail" style="max-height: 100px;" onclick="FuncOpenImage('<?php echo e(asset('/storage/company/'.$company->id.'.jpg')); ?>','<?php echo e($company->name); ?>')"></td>
                        <td class="text-center"><a href="<?php echo e(url('/person/'.$company->id)); ?>" class="btn btn-sm btn-primary">Person</a></td>
                        <td class="text-center"><a href="<?php echo e(url('/address/'.$company->id)); ?>" class="btn btn-sm btn-primary">Address</a></td>
                        <td class="text-center"><button type="button" class="btn btn-sm btn-warning" onclick="FuncCompanyInfo(<?php echo e($company->id); ?>)">Update</button></td>
                        <td class="text-center"><button type="button" class="btn btn-sm btn-danger" onclick="FuncCompanyDelete(<?php echo e($company->id); ?>)">Delete</button></td>
                    </tr>
...
$(document).ready(function () {
    $(document).on('submit', 'form#CompanyForm', function (event) {
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo e(url('/companysave')); ?>",
            data:formdata,
            dataType:'json',
            processData: false,
            contentType: false,
...
function FuncCompanyInfo(cid) {
    if(cid > 0){
        $.ajax({
            type:'POST',
            url:"<?php echo e(url('/companyinfo')); ?>",
            data:{'cid':cid},
            dataType:'json',
        }).done(function (data) {
            if(data){
        ...
        buttons:{
            ...
            delete:{
                ...
                action: function () {
                    $.ajax({
                        type:'POST',
                        url:"<?php echo e(url('/companydelete')); ?>",
                        data:{'cid':cid},
                        dataType:'json',
                    }).done(function (data) {
                        if(data){
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\test-app\resources\views/company/index.blade.php ENDPATH**/ ?>